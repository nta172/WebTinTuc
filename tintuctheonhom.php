                ...
                <div>
                    <?php 
                        if(isset($_GET['id_nhomtin'])) {
                            ...
                            $query_nhomtin = "SELECT ten_nhomtin FROM nhom_tin WHERE id_nhomtin = $id_nhomtin";
                            $result_nhomtin = mysqli_query($conn, $query_nhomtin);
    
                            if($result_nhomtin && mysqli_num_rows($result_nhomtin) > 0) {
                                $row_nhomtin = mysqli_fetch_assoc($result_nhomtin);
                                $ten_nhomtin = $row_nhomtin['ten_nhomtin'];

                                    echo '<div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4"><strong>'.$ten_nhomtin.'</strong></div>';
                                } else {
                                    echo "Không tìm thấy nhóm tin!";
                                }
                        }
                    ?>
                </div>
                <div class="row">
                    <?php 
                                    ...
                                    <div class="col-md-7 animate-box">
                                        <div class="info">
                                            <p class="category" style="float: left; ">
                                                <span style="color: blue;">Nhóm tin:</span> <?php echo $row_blog['ten_nhomtin']; ?>
                                            </p>
                        ...
                        <?php
                            ...
                            echo "<div class='col-12' style='color: red; text-align: center; font-size: 20px'>Không có bài viết thuộc nhóm tin này!</div>";
                        }                
                    }
                    ?>
            </div>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">
                        <strong>Nhóm tin khác</strong>
                    </div>
                </div>
                <div class="clearfix"></div>
                <div class="fh5co_tags_all">  
                    <?php
                        $qr = mysqli_query($conn, "SELECT * FROM `nhom_tin` WHERE `trangthai` = 1");
                        while ($row = mysqli_fetch_assoc($qr)) {
                            $id_nhomtin = $row['id_nhomtin'];
                            $ten_nhomtin = $row['ten_nhomtin'];
                            ?>
                                <div class="nhomtin" data-id_nhomtin="<?php echo $id_nhomtin; ?>">
                                    <a href='<?php echo "$id_nhomtin/" . makeUrl($ten_nhomtin) . ".html"; ?>'><?php echo $ten_nhomtin; ?></a>
                                </div>
                            <?php
                        }
                    ?>

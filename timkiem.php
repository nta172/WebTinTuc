        ...
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">
                        <strong><?php echo $kqtimkiem; ?></strong>
                    </div>
                </div>
                <div class="row">
                    <?php
                        if ($result && mysqli_num_rows($result) > 0) {
                            ...
                            ?>
                                <div class="row pb-4">
                                    ...
                                    <div class="col-md-7 animate-box">
                                        <?php
                                            $query_inner  = "SELECT tin.*, loai_tin.ten_loaitin 
                                            FROM tin 
                                            ...
                                            if ($result_inner  && mysqli_num_rows($result_inner ) > 0) {
                                                $row_inner  = mysqli_fetch_assoc($result_inner );
                                                $tenloaitin = $row_inner ['ten_loaitin'];
                                            } else {
                                        ...
                                        <div class="content" style="float: left;">
                                            <h6><strong><?php echo $row_blog['tieude']?></strong></h6>
                            ...
                            echo "<div class='col-md-12' style='color:red;'>Không có kết quả nào được tìm thấy.</div>";
                        }
                    ?>
                </div>
            </div>
            <!-- <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="fh5co_tags_all"> 
                    <div>
				        <h6 class="title-input">Sắp xếp theo</h6>
                        <div class="sapxep">
				            <select id="sapxep" >   
